...
import (
	...
	"github.com/kube-ianvs/ianvs-operator/client/clientset/versioned/scheme"
...
// ClusterV1Client is used to interact with features provided by the cluster group.
type ClusterV1Client struct {
	restClient rest.Interface
}

// Credentials comment lint rebel
func (c *ClusterV1Client) Credentials() CredentialInterface {
...
// setConfigDefaults comment lint rebel
