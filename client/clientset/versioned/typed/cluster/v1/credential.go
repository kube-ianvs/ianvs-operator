...
import (
	...
	scheme "github.com/kube-ianvs/ianvs-operator/client/clientset/versioned/scheme"
...
type CredentialInterface interface {
	...
	UpdateStatus(ctx context.Context, credential *v1.Credential, opts metav1.UpdateOptions) (*v1.Credential, error)
...
func newCredentials(c *ClusterV1Client) *credentials {
	return &credentials{
		client: c.RESTClient(),
	}
}
...
func (c *credentials) UpdateStatus(ctx context.Context, credential *v1.Credential, opts metav1.UpdateOptions) (result *v1.Credential, err error) {
	result = &v1.Credential{}
	err = c.client.Put().
		Resource("credentials").
		Name(credential.Name).
